...
const GithubCorner = (props: Props) => {
  const { fill = 'black', url = 'https://github.com/omega-station/resume-spa' }: Props = props;
  return (
    <StyledCorner fill={fill} href={url} target="_blank" rel="noopener noreferrer" aria-label="View source on GitHub">
