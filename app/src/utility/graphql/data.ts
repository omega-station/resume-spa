export const data: any = {
  ...
  options: {
    ...
    resume: {
      contactAddress1: '501-1139 Barclay Street',
      contactAddress2: 'Vancouver, BC V6E 1G8',
